...
A simple and clean To-Do web application built using **Django**.  
This project lets users create, update, mark complete, and delete daily tasks in an organized way.  
Perfect for learning Django fundamentals such as **Models, Views, Templates, and CRUD Operations**.
...
| ➕ Add Task | Add tasks with title & description |
| ✏️ Edit Task | Update task details anytime |
| ✅ Complete Task | Mark tasks as completed |
| ❌ Delete Task | Remove tasks you no longer need |
| 🔍 Search Tasks | Quickly filter tasks by keywords |
| 👤 User Personalization | Every user sees only their own tasks |
